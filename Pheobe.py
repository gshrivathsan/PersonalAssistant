...
import file_folder_open as ffo
...
def greet():
    conn = sqlite3.connect('Pheobe.db')
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Pheobe. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Phoebe and I'm here to serve you.")
            #How are you
            ...
            #playing on youtube
            elif there_exists(['video','song'],query):
                if 'video' in query:
            ...
            #image search
                ...
                break
            elif there_exists(["my location"],query):
                Ip_info = requests.get('https://api.ipdata.co?api-key=8144180b860632cb1b1adbf6e94f20c1b6cb4649d9bc1c3e8b8b7743').json()
                loc = Ip_info['region']
            ...
            elif there_exists(['send some files through bluetooth','send files through bluetooth','send file through bluetooth','bluetooth sharing','bluetooth file sharing','open bluetooth'],query):
                SR.speak("Opening bluetooth...")
                os.startfile(r"C:\Windows\System32\fsquirt.exe")
                break

            #play game
            elif there_exists(['I would like to play some games','games','play some games','would like to play some game','want to play some games','want to play game','want to play games','play games','open games','play game','open game'],query):
            ...
            #opening software applications
                ...
                codepath=r"C:\Users\HP\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Visual Studio Code\Code.exe"
                ...
                break
            elif there_exists(['oragznizer'], query):
                SR.speak("Opening organizer")
                os.startfile(r'C:\Users\HP\Downloads\Pheobe\organiser.py')
                break
                ...
                os.startfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\VideoLAN\VLC\vlc.exe")
                break
...
if __name__=="__main__":
        ...
        root.title("Pheobe")
        root.iconbitmap('Pheobe.ico')
        root.configure()
        scrollable_text=scrolledtext.ScrolledText(root, state='normal', font='"Lucida Calligraphy"', height=100, width=144, relief='sunken', bd=5, wrap=tk.WORD, bg='#add8e6', fg='#800000',)
        ...
        Speak_label=tk.Label(root,text="SPEAK", fg="#FFD700", font='"Harrington" 12 ', borderwidth=0, bg='#2c4557')
        Speak_label.place(x=920,y=790)
        """Setting up objects"""
        ...
        Listen_Button.place(x=930,y=720)
        myMenu=tk.Menu(root)
