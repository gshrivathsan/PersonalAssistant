...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.volume=ttk.Label(self.setting,text="Pheobe's Volume: ",borderwidth=0,font=('"Jokerman"')).place(x=3,y=17)
        self.volume=ttk.Label(self.setting,text='Speech Rate[WPM]:',borderwidth=0,font=('"Jokerman"')).place(x=3,y=77)
